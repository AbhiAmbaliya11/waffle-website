-- ============================================================
-- Waffle Castle — Stores Seed Data
-- Run this in Supabase Dashboard → SQL Editor after creating the stores table
-- ============================================================
...
('Nagpur', 'Nandanvan', 'Nandanvan, Nagpur, Maharashtra', 'https://www.zomato.com/ahmedabad/waffle-castle-kankaria/order', true),
